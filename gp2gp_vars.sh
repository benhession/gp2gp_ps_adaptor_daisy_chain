...
export MHS_FORWARD_RELIABLE_ENDPOINT_URL="https://example-mhs-endpoint:8443/reliablemessaging/forwardreliable" # change
export MHS_OUTBOUND_VALIDATE_CERTIFICATE="False"

#MHS_OUTBOUND_ROUTING_LOOKUP_METHOD = SPINE_ROUTE_LOOKUP or SDS_API
export MHS_OUTBOUND_ROUTING_LOOKUP_METHOD="SDS_API"
export MHS_SPINE_ROUTE_LOOKUP_URL="http://example-mhs-endpoint:8086" # change
export MHS_SDS_API_URL="" # change
export MHS_SDS_API_KEY="" # change
...
export MHS_SECRET_INBOUND_QUEUE_USERNAME="admin"
export MHS_SECRET_INBOUND_QUEUE_PASSWORD="admin"
...
export GPC_CONSUMER_SDS_URL="http://example-mhs-host:8080/spine-directory/" # change
